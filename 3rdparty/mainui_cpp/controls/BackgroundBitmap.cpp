...
void CMenuBackgroundBitmap::Draw()
{
	...
	// Try live background first (video takes priority)
	if( TryDrawLiveBackground() )
		return;
...
bool CMenuBackgroundBitmap::TryDrawLiveBackground()
{
	return false;
}

void CMenuBackgroundBitmap::ShutdownLiveBackground()
{
}
