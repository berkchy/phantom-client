...
void CMenuOptions::_Init( void )
{
	...
	AddButton( L( "Font Options" ), L( "Change main menu font and size." ),
		PC_ADV_OPT, UI_FontOptions_Menu, QMF_NOTIFY );
	AddButton( L( "HUD Feedback" ), L( "Tune killmark, death notice, weapon icon and chat HUD." ),
		PC_ADV_OPT, UI_HudFeedback_Menu, QMF_NOTIFY );
